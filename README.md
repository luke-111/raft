...
This repository contains the starter code for project 2 (15-440/15-640, Fall 2025). It also contains
...
godoc -http=:6060
```
If you get an error like "command not found", try the following commands:
```sh
